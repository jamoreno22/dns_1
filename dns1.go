...
func server() {
	...
	lis, err := net.Listen("tcp", "10.10.28.17:8000")
	if err != nil {
...
func spread() {
	...
	for {
		...
		conn1, err1 := grpc.Dial("10.10.28.18", grpc.WithInsecure())
		if err1 != nil {
		...
		for {
			...
			dnsc1.Spread(context.Background(), &lab3.Log{Name: "Log DNS1", Data: logFile})
			dnsc2.Spread(context.Background(), &lab3.Log{Name: "Log DNS1", Data: logFile})
		}
	}
